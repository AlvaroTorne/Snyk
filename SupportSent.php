                ...
                <div class="row">
                    ...
                    <div class="column">
                        <form action="SupportMail.php" method="post">
                            ...
                            <input type="submit" value="Submit" style="background: linear-gradient(to right, #305289 0%, #466FB4 100%) !important;">
                        </form>
                        <!-- alert support sent -->
                        <div class="alert">
                            <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
                            <strong>Thanks!</strong> Your message was sent successfully, you will recieve a reply as
                            soon as possible.
                        </div>
                    </div>
                </div>
