...
<head>
    ...
    .navbar {
        ...
        background: linear-gradient(to right, #305289 0%, #466FB4 100%);
    }
    ...
    .btn-primary {
        color: #fff;
        background: linear-gradient(to right, #305289 0%, #466FB4 100%) !important;
        border-color: #466FB4 !important;
    }

    .btn-primary:hover {
        color: #fff;
        background-color: white !important;
        border-color: #305289 !important;
    ...
    .jumbotron {
        padding: 20% 0;
        background: url("Back/Delivery_tracking@2x.jpg");
...
<body>
    ...
    <div class="wrapper">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand" href="#" style="color: white;">Tracking <b>BUSSES</b></a>
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" style="color:white" href="#about">Why TrackBus?</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"  style="color:white" href="#feature">Features</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color:white" href="Support.php">Support</a>
                        </li>
                        <li class="nav-item dropdown nav-dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" style="color:#C0392B" <button type="button" onclick="document.getElementById('id02').style.display='block'" class="btn btn-primary">Parent</button></a>
                                <a class="dropdown-item" style="color:#C0392B" <button type="button" onclick="document.getElementById('id01').style.display='block'" class="btn btn-primary">Adminstrator</button></a>
        ...
        <section class="about-section text-center" id="about">
            <h2 class="section-title" style="color:#305289;">Why TrackBus?</h2>
            <div class="container">
        ...
        <section class="feature-section text-center" id="feature">
            <h2 class="section-title" style="color: #305289;">Features</h2>
            <div class="container">
                <div class="row slideanim">
                    <div class="col-sm-4">
                        <div class="card">
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <img src="https://img.icons8.com/color/96/000000/defend-family--v2.png"/>
                                ...
                                <button type="button" onclick="document.getElementById('id02').style.display='block'" class="btn btn-primary">Parent</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <section class="text-center" id="testimonial">
            <h2 class="section-title" style="color: #305289;">Our Team</h2>
            <div id="carouselContent" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner text-center" role="listbox">
                    <div class="carousel-item active">
                        ...
                        <div class="quote">
                            <p style="color: #305289;"><strong>- Abbas Kassen Zein</strong><br>CEO & Co-founder.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="quote">
                            <p style="color: #305289;"><strong>- Daniel Serhan</strong><br>Techincal Team Leader.</p>
                        </div>
                    </div>
                </div>
        ...
        <section id="patient">
            <div class="container">
                <div class="row slideanim">
                    ...
                    <div class="col-7">
                        <h1 style="color: #305289;">Download the TrackBUS app</h1>
                        <p style="color: #305289;">TO keep track your children travelling in the school bus;<br>Since GPS location of the school
